...
$cities = ["Mumbai","Delhi","Bangalore","Hyderabad","Ahmadabad","Chennai","Kolkata","Surat","Pune","Kocchin","Gurugram"];


?>

<h2 class="text-center" style="margin-top: 20px">PROVIDER MARINE</h2>
<hr>
    ...
    <div class="row">
        ...
        <div class="form-group col-5">
            ...
            <select class="form-control" name="profession" id="profession">
                ...
                <option value="old">Old age care taker</option>
                <option value="baby">Baby sitter</option>
                <option value="driver">Driver</option>
                <option value="house">House cleaner</option>
